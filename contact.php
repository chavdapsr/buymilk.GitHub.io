...
<meta name="title" content="Neumorphic Pages - Contact">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12">
                                        <div class="shadow-inset p-4 mb-5 rounded">
                                            <iframe class="map rounded" id="gmap_canvas" src="https://maps.google.com/maps/ELeFXYEYg9Lx1zn7A"></iframe>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-8 text-center mb-5">
                                        <h1 class="display-2 mb-3">Get order today</h1>
                                        <p class="lead">buymilk.in is very fastest milk delivery services. we can deliver milk at your doorstep.</p>
                                    </div>
                                </div>
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-4 col-lg-4 text-center">
                                        ...
                                        <div class="icon-box mb-4">
                                            ...
                                            <a href="#">chavda096@gmail.com</a>
                                            <br><a href="#">buymilk.ml@gmail.com</a>
                                        </div>
                                        <!-- End of Email Box -->
                                    </div>
                                </div>
                            ...
                            <form class="col-12 col-md-8 mx-auto">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" id="nameInputIcon2" placeholder="e.g. chavda pravin" type="text" aria-label="contact name input">
                                    </div>
                                </div>
                                <!-- Form -->
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" id="emailInputIcon2" placeholder="example@gmail.com" type="email" aria-label="contact email input">
                                    </div>
                                </div>
                                <!-- Form -->
                                <div class="form-group">
